...
//_=====__
	...
	{
		Piece round = board.Pieces [board.Squares [4, 2]];
		bool result = round.Push.CanPush (board.Squares [5, 2]);
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.Push.CanPush (board.Squares [3, 3]);
		Assert.IsFalse (result);
	}
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.Push.CanPush (board.Squares [4, 2]);
		Assert.IsFalse (result);
	}
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.Push.CanPush (board.Squares [5, 3]);
		Assert.IsTrue (result);

		square.Push.Push (board.Squares [5, 3]);
		Assert.AreEqual (square, board.Pieces [board.Squares [5, 3]]);
	}
	...
	public void PieceCheckMovesAfterMoving ()
	{
		...
		board.Pieces [board.Squares [4, 1]].Move (board.Squares [2, 3]);
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.CanMove (board.Squares [2, 2]);
		Assert.IsTrue (result);

		square.Move (board.Squares [2, 2]);
		Assert.AreEqual (square, board.Pieces [board.Squares [2, 2]]);
	}
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.CanMove (board.Squares [5, 3]);
		Assert.IsFalse (result);

		square.Move (board.Squares [5, 3]);

		Piece movedPiece = null;
		board.Pieces.TryGetValue (board.Squares [5, 3], out movedPiece);
	...
	{
		Piece square = board.Pieces [board.Squares [4, 3]];
		bool result = square.CanMove (board.Squares [6, 4]);
		Assert.IsFalse (result);

		square.Move (board.Squares [6, 4]);

		Piece movedPiece = null;
		board.Pieces.TryGetValue (board.Squares [6, 4], out movedPiece);
		Assert.AreNotEqual (square, movedPiece);
	}
   }
}
