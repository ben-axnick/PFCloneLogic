   ...
   class TestDriver
   {
      public static void Main(string[] args)
      {
         Dictionary<Coords, PieceType> p1Moves = new Dictionary<Coords, PieceType>(){
				{new Coords(){x = 3, y = 1}, PieceType.ROUND},
				{new Coords(){x = 1, y = 2}, PieceType.ROUND},
				{new Coords(){x = 1, y = 3}, PieceType.SQUARE},
				{new Coords(){x = 2, y = 3}, PieceType.SQUARE},
				{new Coords(){x = 2, y = 4}, PieceType.SQUARE}
			};
         ...
         ai.Act("Placement");
         while(true)
            if (!ai.ExecuteNextInstruction()) break;
